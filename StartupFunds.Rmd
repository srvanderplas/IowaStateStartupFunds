...
```{r TotalCost, echo=F, fig.width=6, fig.height=3, fig.cap="Total Startup Package Cost, by College"}
...
```{r ExpenseProportion, echo=F, fig.width=6, fig.height=3, fig.cap="Proportion of startup $ allocated for computers"}
