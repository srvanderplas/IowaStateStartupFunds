...
ggplot(aes(x=YearsAtISU, y=total.pubs, shape=TotalCostFac, color=TotalCostFac), data=subset(citations.yearly, CollegeFac=="LAS")) +
...
```{r GScholarBus, fig.width=6, fig.height=4, dpi=300}
ggplot(aes(x=YearsAtISU, y=total.pubs, shape=TotalCostFac, color=TotalCostFac), 
