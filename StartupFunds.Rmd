...
```{r TotalCost, echo=F, fig.width=6, fig.height=4, fig.cap="Total Startup Package Cost, by College"}
...
```{r ExpenseProportion, echo=F, fig.width=6, fig.height=4, fig.cap="Proportion of startup $ allocated for computers"}
